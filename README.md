# stm32f4d-blinky-asm-makefile
Programa de prueba para la placa 32F746GDISCOVERY que prende ya apaga periódicamente el LED GREEN. El proyecto esta basado en Make y desarrollado en ensamblador.

A continuación como se describe como importarlo en Eclipse y ejecutarlo en la placa.

## Importar el proyecto en Eclipse
Clonar localmente el repositorio y luego en Eclipse:
